...
public class Bankiersessie extends UnicastRemoteObject implements
    ...
    private int reknr;
    private IBank bank;
    private IRekeningUpdateListener listener;
    ...
    @Override
    public void addListener(IRekeningUpdateListener listener) throws RemoteException {
        this.listener = listener;
        bank.addListener(reknr, listener);
    }

    @Override
    public void removeListener(IRekeningUpdateListener listener) throws RemoteException {
        if(listener==null)return;
        bank.removeListener(reknr, listener);
    }
